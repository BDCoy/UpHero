    ...
    <section className="bg-white py-16 border-b border-[#e5e6ea]">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12 max-w-4xl">
        <div className="flex-1 mx-auto text-center md:text-left">
          <h3 className="font-bold text-lg mb-2 text-[#42354e]">Want a quick demo of UGC Sensei?</h3>
          <p className="mb-4 text-[#6f6290]">If you're curious about UGC Sensei, let's hop on a brief demo call. I'll show you how to quickly find the right creators and get videos tailored to your brand.</p>
