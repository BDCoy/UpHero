...
export function UpdatePassword() {
  ...
  return (
    <div className="p-6 bg-white shadow rounded-lg">
      <h3 className="text-lg font-medium text-upwork-gray mb-6">Update Password</h3>
      
      <form onSubmit={formik.handleSubmit} className="space-y-6">
        {/* Current Password */}
        <div>
          <label htmlFor="currentPassword" className="block text-sm font-medium text-upwork-gray">
            Current Password
          </label>
        ...
        {/* New Password */}
        <div>
          <label htmlFor="newPassword" className="block text-sm font-medium text-upwork-gray">
            New Password
          </label>
          <div className="mt-1 relative">
            <input
