...
export function ProfileForm({
  ...
  return (
    <form onSubmit={onSubmit} className="bg-white shadow rounded-lg divide-y divide-upwork-background">
      <div className="p-6">
        <h3 className="text-lg font-medium text-upwork-gray">Profile Information</h3>
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-6">
          <div>
            <label htmlFor="full_name" className="block text-sm font-medium text-upwork-gray">
              Full Name
            </label>
            <div className="mt-1">
              <input
