  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 lg:p-12">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">Privacy Policy</h1>
        ...
        <div className="prose prose-blue max-w-none">
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              <a href="mailto:privacy@freelancehero.io" className="text-blue-600 hover:text-blue-700">
                privacy@freelancehero.io
              </a>
            </p>
          </section>
        </div>
